...
const textVariants = cva('', {
  ...
  variants: {
    ...
    variant: {
      body: 'text-pretty text-sm leading-normal',
      code: 'font-mono text-xs bg-muted rounded px-2 py-1',
      h1: 'text-balance font-heading text-3xl font-semibold tracking-tight',
      h2: 'text-balance font-heading text-2xl font-semibold tracking-tight',
      h3: 'text-balance text-xl font-semibold',
      h4: 'text-balance text-lg font-medium',
      lead: 'text-pretty text-base',
